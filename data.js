...
const resignData = {
  ...
  steps: [
    ...
    },
    {
      ...
      desc: 'OA首页 → 自助服务 → 我要离职。',
      detail: [
        '① 注意选择最后工作日：例如最后工作日为12月1日，离职生效日则选12月2日。不要选错时间！',
        '② 提醒直接上级进行审批。',
        '③ 请自行计算发起时间。若离职流程发起过晚，最后工作日可能需要顺延。',
        '',
        '参考示例：',
        '若需覆盖假期：建议至少提前13天发起（预留3天审批流程 + 提前7天通知 + 包含3天假期）',
        '若无影响：建议至少提前10天发起（预留3天审批流程 + 提前7天通知）'
      ],
    ...
    },
    {
      ...
      signNote: {
        ...
        items: [
          ...
          '② 签字顺序：自己 → 部门领导 → 内勤 → 档案室 → 5楼财务室 → 5楼行政 → 朱颖（到这儿之前全部都要签完）→ 最后是离职考勤',
          '③ 考勤凭据需填写离职日期的实际出勤情况。如若11月办理离职手续但最后工作日为12月末，则只需登记12月出勤。请在提交时核对时间区间是否准确，由部门内勤协助填写。'
        ]
      },
      signFlow: ['自己', '部门领导', '内勤', '档案室', '5楼财务室', '5楼行政', '朱颖'],
      attachmentNote: {
        title: '附件说明',
        items: [
...
const insuranceData = {
  "title": `商业保险 · 员工补充医疗保障`,
  "intro": `公司统一为全体员工购买补充医疗保险，依托「平安企业宝」APP 自助理赔，就医后拍照上传即可，最快 1 天结案、平均 1-2 天到账。`,
  "enrollBanner": {
    "title": `📝 补充医疗保险 · 参保办理说明`,
    "points": [
      {
  ...
  "categories": [
    ...
    },
    {
      ...
      "items": [
        {
          "keyword": `扫码下载平安企业宝`,
          "detail": `使用手机扫描下方二维码下载「平安企业宝」APP，首次登录直接使用<b>手机号登录</b>即可，无需绑定公司企业码。`,
...
const insuranceDocRaw = [
  ...
  {
    "type": `text`,
    "content": `公司统一为全体员工购买补充医疗保险，依托「平安企业宝」APP 自助理赔，就医后拍照上传即可，最快 1 天结案、平均 1-2 天到账。`,
    "bold": false,
    "heading": false
  },
  {
  ...
  {
    "type": `text`,
    "content": `补充医疗保险是公司在社保基本医疗保险之外为员工额外购买的医疗保障，覆盖医疗、意外、购药、重疾四大类，依托平安企业宝 APP 自助理赔，赔款最快 1 天结案、平均 1-2 天到账，500 元以下案件免寄发票原件。`,
    "bold": false,
    "heading": false
  },
  {
...
const SITE_VERSION = '2026.09.18';

const CHANGELOG = [
  { date: '2026-09-18', tag: '修复',   title: '内容准确性核查', desc: '全面核对各模块内容与最新制度文件，确保表述与制度原文保持一致' },
  { date: '2026-08-27', tag: '优化',   title: '小助手「相关推荐」', desc: '答案底部智能推荐相关问题，一点即看：搜到时连带推荐同组问题（如"调休假"连带其它调休假问题），没搜到时推荐相似问题' },
  { date: '2026-08-27', tag: '修复',   title: '修复"调休假"答非所问', desc: '现在正确返回调休假相关说明' },
  { date: '2026-08-11', tag: '修复',   title: '修复详情页显示异常', desc: '部分模块"详细"视图文字已恢复正常显示' },
  { date: '2026-08-06', tag: '新功能', title: '首页全局搜索', desc: '顶部搜索框跨全部模块实时查找，点击直达答案' },
  { date: '2026-08-06', tag: '新功能', title: '「指南汇总」上线', desc: '首页新增汇总页，集中收录制度文件、常用下载与高频问题' },
  { date: '2026-08-06', tag: '优化',   title: '小助手更懂你', desc: '联想与理解能力增强，否定类问题（如"请不了假"）也能精准作答' },
  { date: '2026-08-05', tag: '新功能', title: '一键反馈 HR', desc: '答案没解决你的问题？底部「反馈给 HR」直达' },
...
const faqData = [
  ...
  },
  {
    ...
    "items": [
      {
        "q": `离职需要提前多久申请？`,
        "a": `若需覆盖假期：建议至少提前13天发起（预留3天审批流程 + 提前7天通知 + 包含3天假期）。若无影响：建议至少提前10天发起（预留3天审批流程 + 提前7天通知）。常规情况最后工作日为正式向HR提出申请满一个月。`
      },
      {
      ...
      {
        "q": `离职交接表签字顺序错了怎么办？`,
        "a": `建议严格按照顺序签字（自己→部门领导→内勤→档案室→5楼财务室→5楼行政→朱颖），到朱颖之前全部都要签完，最后是离职考勤。如顺序有误可能导致返工，切记不能删除文档内任何一个字，删了就要重签。`
      }
    ]
  },
  {
    ...
    "items": [
      {
        "q": `HR联系方式是什么？`,
        "a": `可通过悦工作搜索 HR 姓名直接沟通，紧急事项建议直接通过悦工作消息联系。`
      },
      {
        "q": `OA系统地址是什么？`,
...
const INTENT_DEFS = [
  ...
  },
  {
    ...
    answer: `员工转正流程共 7 个环节：\n\n1️⃣ 入职（一周内）— 提交签字版《试用期考核目标责任书》给 HR，内容需线上填写后打印签字，不可手填\n2️⃣ 试用期间 — 完成悦学习「新伙伴计划（越秀商管）-悦汇城商管」线上培训，完成后找 HR 确认\n3️⃣ 转正面谈 — 试用期内 HR 会不定期进行线上或线下沟通面谈\n4️⃣ 转正前 — HR 会在转正前半个月于 OA 工作沟通发出通知，请留意提交时限\n5️⃣ 准备资料 — 打印《考核目标责任书》补评分评语并签字、《转正申请表》线上填写（不少于 2000 字）并评分签字；经理级另需准备答辩 PPT\n6️⃣ 提交资料 — 在要求时限内把两份资料提交给 HR，并确认 HR 已收到\n7️⃣ 转正 — HR 负责提交转正流程，员工提交完资料即完成\n\n💡 更多细节可以点击首页「我要转正」卡片查看～`,
    leadTo: '我要转正'
  },
  {
    intent: 'resign',
    ...
    answer: `离职流程共 6 个步骤：\n\n1️⃣ 与部门负责人沟通 — 沟通离职原因、确认是否离职，并沟通最后工作日\n2️⃣ 正式联系 HR — 与 HR 进行离职面谈\n3️⃣ 发起离职流程 — OA 首页 → 自助服务 → 我要离职，注意最后工作日与离职生效日\n4️⃣ 清算假期 — 系统自动折算年假等假期，与负责人沟通剩余假期安排\n5️⃣ HR 通知 & 打印附件签字 — HR 在工作沟通发出离职通知后，自行打印附件并按顺序签字\n6️⃣ 获取离职证明 — 最后工作日的第二个工作日开具，加盖公章扫描后微信发送\n\n⚠️ 常规情况下，最后工作日为正式向 HR 提出离职申请满一个月。\n\n💡 更多细节可以点击首页「我要离职」卡片查看（需输入密码）～`,
    leadTo: '我要离职'
  },
  {
    intent: 'account',
    ...
    answer: `账号开通共 4 个步骤：\n\n1️⃣ 留意手机短信 — 一般入职当日下午 3 点后才收到账号短信；次日仍未收到再联系 HR\n2️⃣ 修改密码 — 登录 OA 首页（oa.yuexiuproperty.cn）→ 点击「忘记密码」按提示修改（账号一般为姓名全拼）\n3️⃣ 登录验证 — 修改成功后内部所有账号通用同一密码\n4️⃣ 下载 APP — 扫码或通过 OA 首页下载 APP\n\n⚠️ 若电脑端能登录、手机端不行（或反之），可晚点（一般入职当天 6 点后）再试；如仍报错请核对是否输错密码。\n\n💡 更多细节可以点击首页「账号开通」卡片查看～`,
    leadTo: '账号开通'
  },
  {
    intent: 'it',
    source: 'IT内部约定(无权威制度源)',
  ...
  },
  {
    ...
    answer: `外勤指南：\n\n📸 打卡/拍照：不需要。外勤无需打卡或拍照证明，由审批人共担相关责任\n📱 申请：外勤（外出申请）必须提前申请；如事发突然，后补时请补上相关佐证材料\n\n⚠️ 常见问题：\n· 申请了外勤还显示缺卡 → 请确认流程是否办结；若为后补会出现BUG，请发IT单处理\n· 申请了外勤但临时不外出 → 不用处理，在公司正常打卡即可\n· 去西塔开会不批外勤 → 西塔可以打卡，若有特殊情况需申请外勤可沟通\n· 提前回来打卡显示早退 → 同【迟到-Q3】，联系HR处理即可；建议外出申请为9-14点\n· 是否可以连续外勤 → 可以。如打卡时间9-18，就选例如8月10日9:00 - 8月11日18:00，所有班次同理\n\n💡 更多细节可点击首页「考勤指引」卡片查看～`,
    leadTo: '考勤指引'
  },
  {
    intent: 'overtime',
  ...
  },
  {
    ...
    answer: `打卡失败处理：\n\n🔧 当场发现 → 多打几次，确认钉钉显示打卡成功的截图才算成功\n📅 第二天才发现 → 提交补卡申请（当月3次机会以内，最迟次月3日）\n📋 发 IT 单 → ① 有电脑：OA首页 → IT服务台 → 一键报障；② 无电脑：悦工作 → 工作台 → IT服务台 → 故障申报\n📝 IT 单内容：描述清楚发生了什么、需要 IT 帮你解决什么（写不清楚也没关系，IT 会联系你）\n\n💡 更多细节可点击首页「考勤指引」卡片查看～`,
    leadTo: '考勤指引'
  },
  {
    intent: 'cancel_leave',
    source: '考勤指引·请假卡片',
    synonyms: ['销假', '撤假', '消假', '请错假', '请错日期', '不想休', '撤销请假', '取消请假'],
    contextWords: ['请错', '撤销', '销假', '不想休', '不想要', '取消请假'],
    answer: `销假 / 请错日期：\n\n🔄 操作路径 → 登录网页端 OA → 自助服务 → 我要请假 → 我要销假\n📌 请错日期的 → 销假后重新再请\n\n💡 更多细节可点击首页「考勤指引」→「请假」查看～`,
    leadTo: '考勤指引'
  },
  {
    intent: 'leave_operation',
    source: '休假管理细则',
    synonyms: ['组合假', '同时请', '旷工', '排班', '半天假', '后补', '请假证明', '请假要证明', '请假要什么证明', '请假材料', '请假需要什么'],
    contextWords: ['请错了', '不想要', '取消', '显示旷工', '怎么选', '多天', '一次性', '同时请假', '两类假', '请假要证明', '请假证明', '请假材料', '需要什么材料', '请假'],
    answer: `请假操作指南：\n\n📅 一次性请多天 → 正常提交，选择起止日期即可\n⚠️ 组合假期 → 全天建议用同一假期类型（不要上午调休下午年假）\n📋 后补请假 → 急诊/突发生病/加班调休未到账等场景可后补，需备注原因\n📐 排班制半天假 → 按排班时间半天计算\n🚫 显示旷工 → 发IT单调整，尽量一天内用同一个假期种类\n\n💡 更多细节可点击首页「考勤指引」或「请假指南」卡片查看～`,
    leadTo: '考勤指引'
  },
  {
    intent: 'greeting',
...
const WIZARD_DEFS = {
  ...
  sick_proof: {
    ...
    steps: [
      {
        key: 'days',
        ask: '你计划连续请几天病假呢？（10天以内 / 超过10天）',
        retryAsk: '说天数就可以哦～比如：2天、5天、15天',
        parse: function(s) {
          const kw = normalizeSlang(s.toLowerCase());
          ...
          if (/超过10|超过十|10天以上|十天以上|十几天|两周|半个月|一个月|住院|手术/.test(kw)) return '>10';
          if (/[1-9]天|一天|两天|三天|一两天|一周|一星期/.test(kw)) return '≤10';
          if (/\d+/.test(kw)) {
    ...
    resolve: function(answers) {
      if (answers.days === '>10') {
        return '连续病假超过 10 天，除当日病历、病假建议书外，还须另外提供诊断证明、化验单、医疗费用发票等资料。\n\n📋 申请：原则上提前至少 3 个工作日在 OA（含悦工作）提交病假申请。\n⚠️ 急诊可先口头（电话）向审批人请示，获准后于次日下班前补交申请及有效证明，否则按旷工处理。\n⚠️ 连续停工治疗超过 3 天（含 3 天），按公司医疗期津贴标准发放病假工资。\n\n💡 更多细节可点击首页「请假指南」卡片查看～';
      }
      return '病假 10 天以内，需提供医院出具的<b>当日病历、病假建议书</b>等有效证明资料。\n\n1️⃣ 原则上提前至少 3 个工作日在 OA（含悦工作）提交病假申请，获准后方可休假\n2️⃣ 急病/急诊来不及提前请：先电话口头报告审批人，获准后于次日下班前补交申请及有效证明\n\n⚠️ 连续停工超过 3 天（含 3 天）起，按公司医疗期津贴标准发放病假工资。\n\n💡 更多细节可点击首页「请假指南」卡片查看～';
    },
    leadTo: '请假指南'
  },
